<template>
  <div class="site-map" v-show="false">
    <div class="site-map__grid">
      ...
      <div class="site-map_block site-map_block_large">
    ...
    <b-block6 :with-title="false" :font-color="'#ffffff'"></b-block6>
  </div>
</template>

<script>
import BBlock6 from "@/components/BBlock6";
export default {
  components: {
    BBlock6
  }
